...
const customerFields = [
  ...
  static _drawSignatures(doc, invoice, margins, bodyW, startY) {
    ...
    const colsData = [
      { label: 'ผู้สั่งซื้อ',    labelEn: 'Customer Signature',   key: 'customer.signature' },
      { label: 'พนักงานขาย',     labelEn: 'Sale Person',          key: 'salesman.signature' },
    ...
    colsData.forEach((col, i) => {
      ...
      doc
        ...
        .text(col.labelEn, x0, textY1 + 10, { width: colW, align: 'center' });
    });
