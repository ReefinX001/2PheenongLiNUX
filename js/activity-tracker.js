...
(function() {
  ...
  Promise.all([
    ...
    if (!moduleId) {
      ...
      // เพิ่ม mapping สำหรับไฟล์เฉพาะ
      else if (currentFile === 'payment_installments_Pattani') moduleId = 'installments';
      else if (currentFile.includes('installment')) moduleId = 'installments';
      else if (currentFile.includes('payment')) moduleId = 'payments';
    }
