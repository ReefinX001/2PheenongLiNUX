 ...
 * อัปเดตข้อมูลจาก PO หลายรายการพร้อมกัน
 */
router.patch('/batch-update-from-po', productController.batchUpdateProductsFromPO);
 ...
 */
router.patch('/:id/update-from-po', productController.updateProductFromPO);
